...
async def get_ai_client_with_timeout(timeout=30):
    ...
    try:
        ...
        # Get configuration from your environment variables
        subscription_id = os.environ.get('AZURE_SUBSCRIPTION_ID')
        resource_group = os.environ.get('AZURE_RESOURCE_GROUP_NAME')
        project_name = os.environ.get('AZURE_AI_PROJECT_NAME')
        endpoint = os.environ.get('AZURE_OPENAL_ENDPOINT', 'https://abricotnextgen1028338408.openai.azure.com/')
        ...
        # Method 1: Try DefaultAzureCredential first (for managed identity)
        ...
        # Method 2: Try ClientSecretCredential if environment variables are available
        if credential is None and ClientSecretCredential:
